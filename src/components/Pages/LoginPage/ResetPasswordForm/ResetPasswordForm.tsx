...
const ResetPasswordForm: React.FC<Props> = (props: Props) => {
  ...
  const handleSubmitResetPassword = (event: React.FormEvent<any>) => {
    ...
    if (resetPasswordNewPassword === resetPasswordConfirmNewPassword) {
      axios
        .post(
          "https://city-walks-production.up.railway.app/reset-password-with-old-password",
    ...
    <div>
      ...
      <MDBContainer className='page'>
        <div className='reset-password-header-container'>
          ...
          <p>
            Reset your account password by submitting your old password and the
            password you want to replace it with.
          </p>
        </div>
        <form
          onSubmit={handleSubmitResetPassword}
          className='reset-password-form display-form'
        >
          <MDBInput
            type='email'
            name='reset-email'
          ...
          <MDBInput
            ...
            name='old-password'
            id='old-password'
            value={resetPasswordOldPassword}
            label='old password'
            onChange={handleChangeResetPassword}
            minLength='8'
            required
