            ...
            <div>
                ...
                <SectionA content={featuredWalks[0].content1} img={featuredWalks[0].coverImg} alt={featuredWalks[0].walk}/>
                    <div className="center">
                        <MDBBtn data-testid="explore-btn-1" outline color="elegant" className="featured-walks-btn">Explore {featuredWalks[0].walk} <MDBIcon icon="walking" /></MDBBtn>
                    </div>
                </Link>
                <hr/>
                ...
                <SectionB content={featuredWalks[1].content1} img={featuredWalks[1].coverImg} alt={featuredWalks[1].walk}/>
                    <div className="center">
                        <MDBBtn data-testid="explore-btn-2" className="section-b-home-btn" outline color="elegant" className="featured-walks-btn">Explore {featuredWalks[1].walk} <MDBIcon icon="walking" /></MDBBtn>
                    </div>
                </Link>
                <hr/>
                ...
                <div className="center">
                    <MDBBtn data-testid="explore-btn-3" outline color="elegant" className="featured-walks-btn">Explore {featuredWalks[2].walk} <MDBIcon icon="walking" /></MDBBtn>
                </div>
                </Link>
            </div>
