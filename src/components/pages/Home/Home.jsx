                ...
                <MDBContainer>
                    <div>
                        ...
                        <SectionB content={featuredWalks[1].content1} img={featuredWalks[1].coverImg} alt={featuredWalks[1].walk}/>
                            <div className="center">
                                <MDBBtn data-testid="explore-btn-2" className="section-b-home-btn" outline color="elegant" className="featured-walks-btn">Explore {featuredWalks[1].walk} <GiWalkingBoot/></MDBBtn>
                            </div>
                        </Link>
                        <hr/>
